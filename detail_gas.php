...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $('#responsgrafikgas').load('datagrafikgas.php');
        }, 3000); 
...
<body>
    ...
    <div class="container content-wrapper">
        <div class="logo-container">
            ...
            <h3>Grafik Sensor Gas</h3>
            <p class="subtitle">(Data yang ditampilkan 5 data terakhir)</p>
        </div>

        <div class="container">
            <div class="container" id="responsgrafikgas" style="width: 90%"></div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#responsgrafikgas").on("beforeSend", function() {
                $(this).fadeOut(300);
