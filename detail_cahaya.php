...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $('#responsgrafikcahaya').load('datagrafikcahaya.php');
        }, 3000); 
...
<body>
    ...
    <div class="container content-wrapper">
        <div class="logo-container">
            ...
            <h3>Grafik Sensor Cahaya</h3>
            <p class="subtitle">(Data yang ditampilkan 5 data terakhir)</p>
        </div>

        <div class="container">
            <div class="container" id="responsgrafikcahaya" style="width: 90%"></div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#responsgrafikcahaya").on("beforeSend", function() {
                $(this).fadeOut(300);
