...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $('#responsgrafikkelembaban').load('datagrafikkelembaban.php');
        }, 3000); 
...
<body>
    ...
    <div class="container content-wrapper">
        ...
        <div class="container">
            <div class="container" id="responsgrafikkelembaban" style="width: 90%"></div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#responsgrafikkelembaban").on("beforeSend", function() {
                $(this).fadeOut(300);
