...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $('#responsgrafikkelembabanlalat').load('datagrafikkelembabanlalat.php');
        }, 3000); 
...
<body>
    ...
    <div class="container content-wrapper">
        ...
        <div class="container">
            <div class="container" id="responsgrafikkelembabanlalat" style="width: 90%"></div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#responsgrafikkelembabanlalat").on("beforeSend", function() {
                $(this).fadeOut(300);
