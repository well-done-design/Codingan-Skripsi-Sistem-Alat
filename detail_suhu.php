...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $('#responsgrafiksuhulalat').load('datagrafiksuhulalat.php');
        }, 3000); 
...
<body>
    ...
    <div class="container content-wrapper">
        ...
        <div class="container">
            <div class="container" id="responsgrafiksuhulalat" style="width: 90%"></div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#responsgrafiksuhulalat").on("beforeSend", function() {
                $(this).fadeOut(300);
